...
> Turn a working project into a GitHub-ready public release with a Chinese-first bilingual README, bilingual About, topics, verification, PR, and merge flow.
...
`qiaomu-github-publisher` is an Agent Skill for GitHub release polish. It helps turn working projects into public repositories with a Chinese-first bilingual README, bilingual About text, useful topics, real verification, and a complete PR-to-main publishing flow.
